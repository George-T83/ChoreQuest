...
`],encapsulation:2,changeDetection:0})}return i})();var Js=new k("MATERIAL_ANIMATIONS"),Mr=null;function el(){return s(Js,{optional:!0})?.animationsDisabled||s(Un,{optional:!0})==="NoopAnimations"?"di-disabled":(Mr??=s(Yt).matchMedia("(prefers-reduced-motion)").matches,Mr?"reduced-motion":"enabled")}function le(){return el()!=="enabled"}var ze=(function(i){return i[i.FADING_IN=0]="FADING_IN",i[i.VISIBLE=1]="VISIBLE",i[i.FADING_OUT=2]="FADING_OUT",i[i.HIDDEN=3]="HIDDEN",i})(ze||{}),xa=class{_renderer;element;config;_animationForciblyDisabledThroughCss;state=ze.HIDDEN;constructor(a,e,t,n=!1){this._renderer=a,this.element=e,this.config=t,this._animationForciblyDisabledThroughCss=n}fadeOut(){this._renderer.fadeOutRipple(this)}},Er=Bt({passive:!0,capture:!0}),Ca=class{_events=new Map;addHandler(a,e,t,n){let o=this._events.get(e);if(o){let r=o.get(t);r?r.add(n):o.set(t,new Set([n]))}else this._events.set(e,new Map([[t,new Set([n])]])),a.runOutsideAngular(()=>{document.addEventListener(e,this._delegateEventHandler,Er)})}removeHandler(a,e,t){let n=this._events.get(a);if(!n)return;let o=n.get(e);o&&(o.delete(t),o.size===0&&n.delete(e),n.size===0&&(this._events.delete(a),document.removeEventListener(a,this._delegateEventHandler,Er)))}_delegateEventHandler=a=>{let e=ye(a);e&&this._events.get(a.type)?.forEach((t,n)=>{(n===e||n.contains(e))&&t.forEach(o=>o.handleEvent(a))})}},Sn={enterDuration:225,exitDuration:150},tl=800,Sr=Bt({passive:!0,capture:!0}),Tr=["mousedown","touchstart"],Or=["mouseup","mouseleave","touchend","touchcancel"],nl=(()=>{class i{static \u0275fac=function(t){return new(t||i)};static \u0275cmp=S({type:i,selectors:[["ng-component"]],hostAttrs:["mat-ripple-style-loader",""],decls:0,vars:0,template:function(t,n){},styles:[`.mat-ripple {
  overflow: hidden;
  position: relative;
}
...
`],encapsulation:2,changeDetection:0})}return i})();var Mi=(()=>{class i{static \u0275fac=function(t){return new(t||i)};static \u0275mod=B({type:i});static \u0275inj=z({providers:[nn],imports:[Fr,En,la,di,cs,Fn,ds,ie,vt]})}return i})();var Dd=(()=>{class i{static \u0275fac=function(t){return new(t||i)};static \u0275cmp=S({type:i,selectors:[["ng-component"]],hostAttrs:["cdk-text-field-style-loader",""],decls:0,vars:0,template:function(t,n){},styles:[`textarea.cdk-textarea-autosize {
  resize: none;
}
